...
local BypassList={} -- รายชื่อผู้เล่นที่ต้องการระเว้น
...
AimbotTab.newToggle("AIMBOT","Turn Aimbot On/Off",false,function(Aimbot)AimbotEnabled fervor end)
...
AimbotTab.newTextbox("Bypass Player","Enter player name to bypass",function(text)if text~=""then table.insert(BypassList,text)print("Bypassed: "..text)end end) -- เพิ่ม Textbox สำหรับระเว้นบุคคล
