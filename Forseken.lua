...
-- ฟังก์ชันแก้ปริศนาเครื่องปั่นไฟทันที
...
if i == 3 then
    ...
    -- ปุ่มแก้ปริศนาเครื่องปั่นไฟทันที
    local instantRepairButton = Instance.new("TextButton", tabContent)
    instantRepairButton.Size = UDim2.new(0.9, 0, 0, 30)
    instantRepairButton.Position = UDim2.new(0.05, 0, 0, 90)
    instantRepairButton.Text = "แก้ปริศนาเครื่องปั่นไฟทันที"
    instantRepairButton.BackgroundColor3 = Color3.fromRGB(100, 0, 100)
    instantRepairButton.Font = Enum.Font.GothamBold
    instantRepairButton.TextSize = 14
    instantRepairButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    local instantRepairCorner = Instance.new("UICorner", instantRepairButton)
    instantRepairCorner.CornerRadius = UDim.new(0, 8)
    instantRepairButton.MouseButton1Click:Connect(function()
        instantsolvegen() -- เรียกใช้ฟังก์ชันแก้ปริศนาเครื่องปั่นไฟทันที
    end)
end
switchTab(1)
